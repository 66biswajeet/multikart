...
export async function PUT(request, { params }) {
  try {
    ...
    if (body.hide_vendor_email !== undefined)
      store.hide_vendor_email = body.hide_vendor_email ? 1 : 0;
    if (body.hide_vendor_phone !== undefined)
      store.hide_vendor_phone = body.hide_vendor_phone ? 1 : 0;
    ...
    if (
      store.owner_user_id &&
      (body.name || body.email || body.phone || body.country_code)
    ) {
      const updateData = {};
