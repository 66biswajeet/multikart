...
export async function POST(request) {
    try{
        ...
        if(!existingUser){
            return NextResponse.json({success: false, message : "Invalid credentials", data: null}, {status : 400});
        }
        ...
        return NextResponse.json({success: true, message : "Signin successful", data: { user: existingUser, token }}, {status : 200});
