...
//         if (
//           fetchedProduct &&
//           fetchedProduct.variant_values &&
//           fetchedProduct.variant_values.length > 0
//         ) {
...
//             fetchedProduct.variant_values =
//               masterProductRes.data.data.variant_values || [];
//           }
//         }
...
//   const hasVariants =
//     product &&
//     Array.isArray(product.variant_values) &&
...
//       const variantId =
//         typeof variant.variant_id === "object"
...
//                       <strong>Product Variants:</strong> Select the variant
//                       options you want to offer for this product.
//                     </div>
...
//                         values.selected_variants?.[variantId] || [];
...
import VendorAddProductWizard from "@/components/vendor/VendorAddProductWizard";

const VendorProductEditPage = () => {
  const params = useParams();
  // Capture the ID from the URL (folder name is [productId])
  ...
  return (
    <div className="container-fluid">
      <Row>
        <Col sm="12">
          {/* Reuse the Wizard Component in Edit Mode */}
          {/* The Wizard will handle fetching data using this ID */}
          <VendorAddProductWizard editId={editId} />
        </Col>
      </Row>
    </div>
  );
