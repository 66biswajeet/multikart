...
import { Card, CardBody, FormGroup, Label, Button, Col, Row } from "reactstrap";
    ...
    async function fetchData() {
      ...
      try {
        ...
        if (!inventoryRes.data?.success) {
          throw new Error(
            inventoryRes.data?.message || "Failed to fetch inventory"
          );
        }
          ...
          <Card>
            <CardBody>
              ...
              <Formik
                initialValues={{
                  product_id:
                    inventory.product?._id || inventory.product_id || "",
                  warehouse_id:
                    inventory.warehouse?._id || inventory.warehouse_id || "",
                ...
                onSubmit={async (values) => {
                  ...
                  try {
                    ...
                    toast.error(
                      error?.message || t("Failed to update inventory")
                    );
