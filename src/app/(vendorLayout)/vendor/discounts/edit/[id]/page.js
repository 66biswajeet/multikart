    ...
    async function fetchData() {
      ...
      try {
        ...
        if (!discountRes.data?.success) {
          throw new Error(
            discountRes.data?.message || "Failed to fetch discount"
          );
        }
              ...
              <Formik
                initialValues={{
                  ...
                  end_date: discount.end_date
                    ...
                    : "",
                  status:
                    discount.status !== undefined ? discount.status : true,
                }}
                ...
                onSubmit={async (values) => {
                  ...
                  try {
                    ...
                    toast.error(
                      error?.message || t("Failed to update discount")
                    );
