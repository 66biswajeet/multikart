    ...
    async function fetchWarehouses() {
      try {
        ...
        const res = await request(
          { url: "vendor/warehouse", method: "get" },
          router
        );
                ...
                {hasVariants && uniqueVariants.length > 0 && (
                  <div className="mb-4">
                    ...
                    <p className="text-muted small mb-3">
                      Select variant options for this product. Input type adapts
                      based on variant type (color picker for colors, image
                      selection for patterns, etc.)
                    </p>
