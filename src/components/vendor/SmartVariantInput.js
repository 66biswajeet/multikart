...
const SmartVariantInput = ({
  ...
  const variantData =
    typeof variant.variant_id === "object" ? variant.variant_id : null;
        ...
        <div className="smart-variant-input">
          ...
          <div className="mb-3">
            <p className="text-muted small mb-2">
              Select from official colors (
              {variantOptions.filter((o) => o.active).length} available):
            </p>
              ...
              <div className="border rounded p-3 mt-2 bg-light">
                {customColorLabel && (
                  <div className="alert alert-info py-2 mb-2 small text-dark">
                    💡 Color "{customColorLabel}" is pre-filled. You can modify
                    it or use as-is.
                  </div>
                )}
                <div className="row">
            ...
            <div className="selected-values-display bg-success bg-opacity-10 border border-success rounded p-2">
              ...
              <div className="d-flex flex-wrap gap-2">
                {selectedValues.map((value, idx) => {
                  ...
                  const displayLabel = isCustomColor
                    ? value.split("|")[0]
                    : value;
                  const colorHex = isCustomColor
                    ? value.split("|")[1]
                    : variantOptions.find((o) => o.label === value)?.value ||
                      "#CCCCCC";
