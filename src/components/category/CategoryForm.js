...
const CategoryForm = ({ setResetData, updateId, loading, type, buttonName }) => {
  ...
  return (
        ...
        initialValues={{
          ...
          category_image: updateId ? oldData?.data?.category_image || null : null,
          category_icon: updateId ? oldData?.data?.category_icon || null : null,
          category_meta_image: updateId ? oldData?.data?.category_meta_image || null : null,
          ...
          parent_id: updateId ? oldData?.data?.parent_id || undefined : undefined,
        }}
        ...
        onSubmit={async (values, helpers) => {
          ...
          try {
            ...
            if (values.category_image instanceof File) {
              ...
              console.log("📎 Appending category_image file:", values.category_image.name);
            ...
            if (values.category_icon instanceof File) {
              ...
              console.log("📎 Appending category_icon file:", values.category_icon.name);
            ...
            if (values.category_meta_image instanceof File) {
              ...
              console.log("📎 Appending category_meta_image file:", values.category_meta_image.name);
            ...
            if (response?.success || response?.data || response?.status === 201 || response?.status === 200) {
              ToastNotification("success", updateId ? t("CategoryUpdatedSuccessfully") : t("CategoryCreatedSuccessfully"));
            ...
            ToastNotification("error", error?.response?.data?.message || error?.message || "An error occurred");
          } finally {
        ...
        {({ setFieldValue, values, errors }) => (
          <Form className="theme-form theme-form-2 mega-form">
            <Row>
              ...
              <MultiSelectField errors={errors} values={values} setFieldValue={setFieldValue} name="parent_id" title={"SelectParent"} data={updatedData} getValuesKey="_id" />
